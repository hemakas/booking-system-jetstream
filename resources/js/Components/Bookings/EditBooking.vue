...
<script>
    export default {
        ...
        data() {
            return {
                form: {
                    channel: this.booking.channel_id,
                    room: this.booking.room_id,
                    ratePlan: this.booking.rate_plan_id,
                    noOfRooms: this.booking.no_of_rooms,
                    ...
                    mobile: this.booking.contact_mobile,
                    email: this.booking.contact_email,
                    noOfAdults: this.booking.no_of_adults,
                    noOfChildren: this.booking.no_of_children,
        ...
        methods: {
            ...
            submit() {
                this.$inertia.put(`/bookings/${this.booking.id}`, this.form)
            },
        },
